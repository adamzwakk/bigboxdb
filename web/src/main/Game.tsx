                    ...
                    <div className="flex-2">
                        ...
                        <div className="bg-black/50 p-5 mt-5">
                            ...
                            <ul className='gameLinks mt-2'>
                                ...
                                {game.igdb_slug && game.igdb_slug != "" && <li className='inline'><a href={"https://www.igdb.com/games/"+game.igdb_slug} target='_blank' className={"igdb w-[32px] h-[32px] bg-no-repeat bg-size-[100%] inline-block mr-2"}></a></li>}
